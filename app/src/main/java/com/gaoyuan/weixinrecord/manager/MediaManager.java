...
public class MediaManager {
    ...
    private static void changeAdapterType(boolean on) {
        ((Activity) mContext).setVolumeControlStream(android.media.AudioManager.STREAM_SYSTEM);
        pause();
        if (on) {
            //扩音声筒
            ...
            mAudioManager.setMode(android.media.AudioManager.MODE_NORMAL);
            mAudioManager.setMode(android.media.AudioManager.MODE_IN_COMMUNICATION);
